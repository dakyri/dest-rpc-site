...
// edit control buttons for this table
	...
	echo "<tr>\n";
 	echo "<td><B>";submit_input("edAction","Delete items", NULL, NULL, NULL, "sqlschema_delete_button_{$schema}_{$ext}"); echo "</B></td>\n";
 	echo "<td><B>";submit_input("edAction", "Modify selected", NULL, NULL, true, "sqlschema_modify_button_{$schema}_{$ext}"); echo "</B></td>\n";
 	echo "<td><B>";submit_input("edAction", "Insert item", NULL, NULL, NULL, "sqlschema_insert_button_{$schema}_{$ext}"); echo "</B></td>\n";
